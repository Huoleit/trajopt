...
int main() {
  ...
  PointCloud<PointXYZ>::Ptr cloud = readPCDXYZ("/home/joschu/Downloads/laser_cloud.pcd");
...
#define randf() ((float)rand()) / RAND_MAX
    ...
    handles.push_back(viewer->drawtrimesh((float*)&hr.m_OutputVertices[0], 16, (int*)&hr.m_Indices[0], hr.mNumFaces,
                                          RaveVectorf(randf(), randf(), randf(), 1)));
