...
struct IncrementalRB : public Configuration {
  ...
  IncrementalRB(OpenRAVE::KinBodyPtr body) : m_body(body), m_r(0, 0, 0), m_q(1, 0, 0, 0) {}
  ...
  virtual DblVec RandomDOFValues() { return toDblVec(VectorXd::Random(6)); }
  virtual vector<OpenRAVE::KinBodyPtr> GetBodies() { return singleton(m_body); }
};
