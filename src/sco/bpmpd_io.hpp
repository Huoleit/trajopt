...
struct bpmpd_input {
  ...
  bpmpd_input() {}
  bpmpd_input(int m, int n, int nz, int qn, int qnz, const vector<int>& acolcnt, const vector<int>& acolidx,
              const vector<double>& acolnzs, const vector<int>& qcolcnt, const vector<int>& qcolidx,
              const vector<double>& qcolnzs, const vector<double>& rhs, const vector<double>& obj,
              const vector<double>& lbound, const vector<double>& ubound)
      : m(m),
        n(n),
        nz(nz),
        qn(qn),
...
struct bpmpd_output {
  ...
  double opt;
  bpmpd_output() {}
  bpmpd_output(const vector<double>& primal, const vector<double>& dual, const vector<int>& status, int code,
               double opt)
